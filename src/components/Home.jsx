...
const Home = () => {
  return (
    <div className="relative bg-gradient-to-r from-purple-600 to-blue-600 h-[46rem] text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center">
        ...
        <p className="text-lg text-gray-100 mb-8">
          Discover amazing products and services that await you.
        </p>
        <Link
          to={'/products'}
